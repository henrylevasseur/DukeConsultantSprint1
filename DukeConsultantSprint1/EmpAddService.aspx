    ...
    <html>
        ...
        <div>
            ...
            <fieldset> 
                ...
                <asp:Label ID="ServiceHeader" runat="server" Text="Please Enter Service Information Below" Font-Bold ="true" Font-Size ="15" Font-Name="Open Sans"></asp:Label>
                <br />
                <asp:Table ID="tableService" runat="server" class="table-warning">
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell>
                            <asp:TextBox ID="txtOpenDate" runat="server" TextMode="Date" type="Open Date" class="form-control" placeholder="Open Date"></asp:TextBox>
                        </asp:TableCell>
                        <asp:TableCell>
